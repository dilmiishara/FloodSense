...
const extraCSS = `
  ...
  .section-toggle-btn { transition: all .18s; border: 1.5px solid #e8e4df; cursor: pointer; font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 700; border-radius: 12px; padding: 10px 22px; }
  .section-toggle-btn:hover { border-color: #1a1a1a; }
`;
        ...
        <>
            ...
            <div style={{ display:"flex", margin:"12px 14px 14px", gap:12 }}>
                            ...
                            <Card>
                                ...
                                <div style={g2}>
                                    {SENSOR_CHIPS.map(({ icon, label, sub, color }) => (
                                        <div key={label} style={{ background:"#f7f5f2", borderRadius:12,
                                ...
                                <div style={{ marginTop:10, padding:"9px 14px", background:"#f7f5f2",
                                    border:"1.5px solid #e8e4df", borderRadius:10, fontSize:11, color:"#aaa" }}>
                                ...
                                <div style={g2}>
                                    <FormGroup label="GPS Latitude *">
                                        <div style={{ position:"relative" }}>
                                            ...
                                            <span style={{ position:"absolute", right:13, top:"50%", transform:"translateY(-50%)",
                                                fontSize:11, color:"#aaa", pointerEvents:"none", fontFamily:"'DM Mono',monospace" }}>°N</span>
                                        </div>
                                    </FormGroup>
                                    <FormGroup label="GPS Longitude *">
                                        <div style={{ position:"relative" }}>
                                            ...
                                            <span style={{ position:"absolute", right:13, top:"50%", transform:"translateY(-50%)",
                                                fontSize:11, color:"#aaa", pointerEvents:"none", fontFamily:"'DM Mono',monospace" }}>°E</span>
                                        </div>
                                    </FormGroup>
                                </div>
                            </Card>
                                    ...
                                    {[
                                        ...
                                        <FormGroup key={label} label={label}>
                                            <div style={{ position:"relative" }}>
                                                ...
                                                <span style={{ position:"absolute", right:13, top:"50%", transform:"translateY(-50%)",
                                                    fontSize:11, color:"#aaa", pointerEvents:"none", fontFamily:"'DM Mono',monospace" }}>m</span>
                                            </div>
                                        </FormGroup>
                                    ))}
                                </div>
                                <div style={{ marginTop:12, padding:"10px 14px", background:"#fff4ec",
                                    border:"1.5px solid #ffdcc2", borderRadius:10, fontSize:11, color:C.orange }}>
                            ...
                            <Card>
                                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
                                    <div>
                                        ...
                                        <div style={{ fontSize:11, color:"#aaa", marginTop:2 }}>Manage registered network nodes</div>
                                    </div>
                                ...
                                {filteredNodes.length === 0 ? (
                                    <div style={{ padding:"40px 0", textAlign:"center" }}>
                                        ...
                                        <div style={{ fontSize:14, fontWeight:700, marginBottom:4 }}>No nodes yet</div>
                                        <div style={{ fontSize:12, color:"#aaa" }}>Register a node to get started</div>
                                    </div>
                                ) : (
                                    <table>
                                        <thead>
                                        ...
                                        {filteredNodes.map(n => (
                                            <tr key={n.id} onClick={() => setSelectedId(n.id)}
                                                style={{ cursor:"pointer", background: selectedId===n.id ? "#faf9f7" : "transparent" }}>
                                                <td><div style={{ fontWeight:700, fontSize:13 }}>{n.name}</div><div style={{ fontSize:10, color:"#aaa" }}>{n.district}</div></td>
                                                <td style={{ fontFamily:"'DM Mono',monospace", fontSize:11, color:"#666" }}>{n.deveui.slice(0,8)}…</td>
                                                <td>{n.gateway}</td>
                                                <td>{n.location}</td>
                                                <td><Badge type={n.status}>{n.status.toUpperCase()}</Badge></td>
                                                <td style={{ fontFamily:"'DM Mono',monospace", fontSize:11, color:"#aaa" }}>{n.lastSeen}</td>
                            ...
                            <Card>
                                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
                                    <div>
                                        ...
                                        <div style={{ fontSize:11, color:"#aaa", marginTop:2 }}>LoRa network gateways</div>
                                    </div>
                                ...
                                <table>
                                    ...
                                    {gateways.map(g => (
                                        <tr key={g.id}>
                                            ...
                                            <td style={{ fontFamily:"'DM Mono',monospace", fontSize:11, color:"#666" }}>{g.eui}</td>
                                            <td>{g.location}</td>
                                            <td><span style={{ fontWeight:800, color:C.blue, fontFamily:"'DM Mono',monospace" }}>{nodes.filter(n => n.gatewayId === g.id).length}</span></td>
                ...
                <div style={{ width:252, display:"flex", flexDirection:"column", gap:12, flexShrink:0 }}>
                    <Card style={{ padding:"16px 18px" }}>
                        <div style={{ fontSize:11, fontWeight:700, color:"#aaa", textTransform:"uppercase", letterSpacing:.5, marginBottom:12 }}>Network Nodes</div>
                        {nodes.length === 0 ? (
                            ...
                            <div key={n.id} onClick={() => setSelectedId(n.id)} className="al-node-card"
                                ...
                                <span style={{ width:8, height:8, borderRadius:"50%", flexShrink:0,
                                    background: n.status==="active" ? C.green : "#ddd", display:"inline-block" }} />
                                <div style={{ flex:1, minWidth:0 }}>
                                    <div style={{ fontSize:12, fontWeight:700, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>{n.name}</div>
                                    <div style={{ fontSize:10, color:"#aaa" }}>{n.gateway}</div>
                                </div>
                                <div style={{ fontSize:10, color:"#aaa", fontFamily:"'DM Mono',monospace", whiteSpace:"nowrap" }}>{n.rssi} dBm</div>
                            </div>
                        ))}
                    </Card>
                    ...
                    {selectedNode && (
                        <Card style={{ padding:"16px 18px" }}>
                            <div style={{ fontSize:11, fontWeight:700, color:"#aaa", textTransform:"uppercase", letterSpacing:.5, marginBottom:12 }}>
                            ...
                            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:10 }}>
                                {[
                                    ...
                                    <div key={label} style={{ background:"#f7f5f2", border:"1.5px solid #e8e4df", borderRadius:10, padding:"10px 11px" }}>
                                        <div style={{ fontSize:15, marginBottom:3 }}>{icon}</div>
                                        <div style={{ fontSize:9, color:"#aaa", textTransform:"uppercase", letterSpacing:.4, fontWeight:700 }}>{label}</div>
                    ...
                    <Card style={{ padding:"16px 18px" }}>
                        <div style={{ fontSize:11, fontWeight:700, color:"#aaa", textTransform:"uppercase", letterSpacing:.5, marginBottom:10 }}>Recent Activity</div>
                        <div style={{ fontSize:12, color:"#aaa", borderBottom:"1px solid #fafafa", paddingBottom:6, marginBottom:6 }}>System started</div>
            ...
            <Modal show={!!deleteTarget} onClose={() => setDeleteTarget(null)} title="Delete Node?"
                ...
                <div style={{ textAlign:"center", padding:"8px 0" }}>
                    <div style={{ width:60, height:60, background:"#fff0ee", borderRadius:16, display:"flex", alignItems:"center", justifyContent:"center", fontSize:28, margin:"0 auto 16px" }}>🗑️</div>
                    <div style={{ fontSize:14, color:"#1a1a1a", marginBottom:6 }}>Are you sure you want to delete</div>
                    <div style={{ fontSize:16, fontWeight:900, color:C.red, fontFamily:"'DM Mono',monospace", marginBottom:16 }}>{deleteTarget?.name}</div>
                    <div style={{ fontSize:12, color:"#aaa", lineHeight:1.6 }}>All readings and alerts for this node will be permanently removed.<br/>This action cannot be undone.</div>
                </div>
            </Modal>
...
function SafeLocationManager() {
    ...
    const LOCATION_STATUS_OPTIONS = [
        { val:"available", label:"Available",   color:C.green  },
        { val:"limited",   label:"Limited",     color:C.orange },
        { val:"full",      label:"Full",        color:C.red    },
        { val:"inactive",  label:"Inactive",    color:"#aaa"   },
    ];
    ...
    return (
        <>
            ...
            <div style={{ background:"#fff", borderRadius:16, margin:"14px 14px 0",
                ...
                <div style={{ display:"flex", gap:8, alignItems:"center" }}>
                    <StatPill label="Total"     value={locations.length} accent="#1a1a1a" />
                    <StatPill label="Available" value={available}        accent={C.green} />
                    <StatPill label="Full"      value={full}             accent={C.red}   />
                    <StatPill label="Capacity"  value={totalCap}         accent={C.blue}  />
                </div>
            </div>
                    ...
                    {activeTab === "register" && (
                        <div className="fadeUp" style={{ display:"flex", flexDirection:"column", gap:12 }}>
                            ...
                            <Card>
                                ...
                                <div style={{ marginTop:10, padding:"9px 14px", background:"#f0fdf4",
                                    border:"1.5px solid #bbf7d0", borderRadius:10, fontSize:11, color:"#166534" }}>
                                    ...
                                    {LOCATION_STATUS_OPTIONS.map(({ val, label, color }) => (
                                        <button key={val} onClick={() => setFStatus(val)}
                                                style={{
                                                    ...
                                                    border:`2px solid ${fStatus === val ? color : "#e8e4df"}`,
                                                    background: fStatus === val ? `${color}18` : "#f7f5f2",
                                                    color: fStatus === val ? color : "#888",
                    ...
                    {activeTab === "manage" && (
                        <div className="fadeUp">
                            <Card>
                                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
                                    <div>
                                        <div style={{ fontSize:14, fontWeight:800 }}>Safe Locations</div>
                                        <div style={{ fontSize:11, color:"#aaa", marginTop:2 }}>Manage registered shelters and evacuation points</div>
                                    </div>
                                ...
                                {filtered.length === 0 ? (
                                    <div style={{ padding:"40px 0", textAlign:"center" }}>
                                        <div style={{ fontSize:38, marginBottom:10 }}>🏠</div>
                                        <div style={{ fontSize:14, fontWeight:700, marginBottom:4 }}>No safe locations yet</div>
                                        <div style={{ fontSize:12, color:"#aaa" }}>Register a shelter to get started</div>
                                    </div>
                                ) : (
                                    <table>
                                        <thead>
                                        ...
                                        {filtered.map(l => (
                                            <tr key={l.id} onClick={() => setSelectedId(l.id)}
                                                style={{ cursor:"pointer", background: selectedId===l.id ? "#f0fdf4" : "transparent" }}>
                                                <td>
                                                    <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                                                        <span style={{ fontSize:16 }}>{l.icon}</span>
                                                        <div>
                                                            <div style={{ fontWeight:700, fontSize:13 }}>{l.name}</div>
                                                            <div style={{ fontSize:10, color:"#aaa" }}>{l.address || "—"}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td style={{ fontSize:12, color:"#666" }}>{l.type}</td>
                                                <td>{l.district}</td>
                                                <td style={{ fontFamily:"'DM Mono',monospace", fontWeight:700 }}>{l.capacity.toLocaleString()}</td>
                                                <td style={{ fontSize:12, color:"#666" }}>{l.contact || "—"}</td>
                                                <td>
                                                ...
                                                <td style={{ display:"flex", gap:4 }}>
                                                    <button onClick={e => { e.stopPropagation(); openEdit(l); }}
                                                            style={{ width:30, height:30, borderRadius:8, border:"1.5px solid #e8e4df",
                                                                background:"#f7f5f2", color:"#888", cursor:"pointer", fontSize:12,
                ...
                <div style={{ width:252, display:"flex", flexDirection:"column", gap:12, flexShrink:0 }}>
                    ...
                    <Card style={{ padding:"16px 18px" }}>
                        ...
                        {locations.length === 0 ? (
                            <div style={{ padding:"20px 0", textAlign:"center" }}>
                                <div style={{ fontSize:24, marginBottom:6 }}>🏠</div>
                                <div style={{ fontSize:11, color:"#aaa" }}>No shelters registered</div>
                            </div>
                        ) : locations.map(l => (
                            <div key={l.id} onClick={() => setSelectedId(l.id)} className="al-node-card"
                                 style={{ display:"flex", alignItems:"center", gap:9, padding:"9px 10px", borderRadius:10,
                                     border:`1.5px solid ${selectedId===l.id ? "#1a1a1a" : "#e8e4df"}`,
                                     marginBottom:7, cursor:"pointer", transition:".15s",
                                     background: selectedId===l.id ? "#f0fdf4" : "#fff" }}>
                                <span style={{ fontSize:16, flexShrink:0 }}>{l.icon}</span>
                                <div style={{ flex:1, minWidth:0 }}>
                                    <div style={{ fontSize:12, fontWeight:700, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>{l.name}</div>
                                    <div style={{ fontSize:10, color:"#aaa" }}>{l.district}</div>
                                </div>
                                <span style={{ width:8, height:8, borderRadius:"50%", flexShrink:0, display:"inline-block",
                                    background: l.status==="available" ? C.green : l.status==="full" ? C.red : "#ddd" }} />
                            </div>
                        ))}
                    </Card>
                    ...
                    {selectedLoc && (
                        <Card style={{ padding:"16px 18px" }}>
                            <div style={{ fontSize:11, fontWeight:700, color:"#aaa", textTransform:"uppercase", letterSpacing:.5, marginBottom:10 }}>
                            ...
                            {[
                                ...
                                <div key={label} style={{ display:"flex", justifyContent:"space-between",
                                    ...
                                    <span style={{ color:"#aaa", fontWeight:600 }}>{label}</span>
                                    <span style={{ color:"#1a1a1a", fontWeight:500, textAlign:"right", maxWidth:130, wordBreak:"break-word" }}>{value}</span>
                                </div>
                            ))}
                            {selectedLoc.notes && (
                                <div style={{ marginTop:10, padding:"8px 10px", background:"#f7f5f2",
                                    border:"1.5px solid #e8e4df", borderRadius:8, fontSize:11, color:"#666", lineHeight:1.5 }}>
                                    {selectedLoc.notes}
                                </div>
                            )}
                        </Card>
            ...
            <Modal show={!!deleteTarget} onClose={() => setDeleteTarget(null)} title="Remove Safe Location?"
                ...
                <div style={{ textAlign:"center", padding:"8px 0" }}>
                    <div style={{ width:60, height:60, background:"#fff0ee", borderRadius:16, display:"flex", alignItems:"center", justifyContent:"center", fontSize:28, margin:"0 auto 16px" }}>🗑️</div>
                    <div style={{ fontSize:14, color:"#1a1a1a", marginBottom:6 }}>Remove this shelter from the system?</div>
                    <div style={{ fontSize:16, fontWeight:900, color:C.red, marginBottom:16 }}>{deleteTarget?.name}</div>
                    <div style={{ fontSize:12, color:"#aaa", lineHeight:1.6 }}>It will no longer appear on the map or in reports.<br/>This action cannot be undone.</div>
                </div>
            </Modal>
    ...
    return (
        <>
            ...
            <div style={{
                ...
                {/* Label */}
                <div style={{ fontSize:13, fontWeight:700, color:"#aaa", marginRight:4 }}>
                    You are managing:
                </div>
                ...
                <button
                    ...
                    style={{
                        background: section === "iot" ? "#1a1a1a" : "#f7f5f2",
                        color:      section === "iot" ? "#fff"    : "#666",
                        borderColor:section === "iot" ? "#1a1a1a" : "#e8e4df",
                    }}
                >
                ...
                <button
                    ...
                    style={{
                        background: section === "safe" ? C.green  : "#f7f5f2",
                        color:      section === "safe" ? "#fff"   : "#666",
                        borderColor:section === "safe" ? C.green  : "#e8e4df",
                    }}
                >
                ...
                {/* Contextual hint */}
                <div style={{ marginLeft:"auto", fontSize:11, color:"#bbb", maxWidth:220, lineHeight:1.5 }}>
                    {section === "iot"
